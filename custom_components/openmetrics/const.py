...
CONF_CUSTOM_METRICS = "custom_metrics"
CONF_CUSTOM_METRIC_ID = "id"
CONF_CUSTOM_METRIC_RESOURCE = "resource"
CONF_CUSTOM_METRIC_QUERY = "metric_query"
CONF_CUSTOM_METRIC_NAME = "entity_name"
CONF_CUSTOM_METRIC_UNIT = "unit"
CONF_CUSTOM_METRIC_ICON = "icon"
CONF_CUSTOM_METRIC_DEVICE_CLASS = "device_class"
CONF_CUSTOM_METRIC_STATE_CLASS = "state_class"
CONF_CUSTOM_METRIC_PRECISION = "display_precision"
CONF_CUSTOM_METRIC_GROUP_BY = "group_by"

CUSTOM_METRIC_DATA_PREFIX = "_custom_"
